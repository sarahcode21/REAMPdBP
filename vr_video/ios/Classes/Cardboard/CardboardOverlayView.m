...
@interface CardboardOverlayView ()
...
@implementation CardboardOverlayView
...
- (instancetype)initWithFrame:(CGRect)frame createTransitionView:(BOOL)createTransitionView {
  if (self = [super initWithFrame:frame]) {
    ...
    UIEdgeInsets insets = [CardboardOverlayView landscapeModeSafeAreaInsets];
    ...
    [_backButton setTitle:@"\U00002039" forState:UIControlStateNormal];
    [_backButton.titleLabel setFont:[UIFont systemFontOfSize:32]];
    ...
    _settingsBackgroundView.autoresizingMask = UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth;
...
- (void)layoutSubviews {
  ...
  CGFloat alignmentMarkerHeight = [CardboardOverlayView alignmentMarkerHeight];
...
- (void)updateMenuButtonsInsetViewFrame {
  UIEdgeInsets menuButtonsInsets = [CardboardOverlayView landscapeModeSafeAreaInsets];
